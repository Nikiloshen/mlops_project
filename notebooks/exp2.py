...
dagshub.init(repo_owner='Nikiloshen', repo_name='mlops_project', mlflow=True)
mlflow.set_experiment("Experiment 2")  # Name of the experiment in MLflow
mlflow.set_tracking_uri('https://dagshub.com/Nikiloshen/mlops_project.mlflow')  # URL to track the experiment

# Load the dataset from CSV file and split into training and testing sets
data = pd.read_csv("H:/water_potability.csv")
